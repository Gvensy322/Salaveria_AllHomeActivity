...
<h>A PHP script is executed on the server, and the plain HTML result is sent back to the browser.</p>
...
<a href=https://www.w3schools.com/pHP/php_syntax.asp>See Sample Syntax of PHP </a>
